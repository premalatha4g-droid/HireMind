      ...
      <div className="auth-card">
        ...
        {!needsVerification ? (
          <>
            {/* Role Selection */}
            <div className="mb-4">
              <label className="form-label text-xs font-bold text-slate-700 block mb-2">I want to register as:</label>
              <div className="grid grid-cols-3 sm:grid-cols-5 gap-1.5">
                {[
                  { key: 'CANDIDATE', label: 'Candidate', icon: User },
                  { key: 'RECRUITER', label: 'Recruiter', icon: Briefcase },
                  { key: 'INTERVIEWER', label: 'Interviewer', icon: Award },
                  { key: 'HIRING_MANAGER', label: 'Manager', icon: Sparkles },
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col items-center justify-center p-2 rounded-lg border text-center transition-all cursor-pointer ${
                        isActive 
                          ? 'border-indigo-600 bg-indigo-50/80 text-indigo-700 font-bold ring-1 ring-indigo-600 shadow-xs' 
                          : 'border-slate-200 bg-white text-slate-600 hover:bg-slate-50'
                      }`}
                    >
                      <Icon className="h-4 w-4 mb-1" />
                      <span className="text-[10px] font-semibold truncate w-full">{r.label}</span>
                    </button>
                  );
                })}
              </div>
            ...
            <form className="space-y-4" onSubmit={handleRegisterSubmit}>
              ...
              <div>
                <button
                  ...
                  className="w-full flex items-center justify-center space-x-2 py-2 px-3 bg-white hover:bg-slate-50 border border-slate-200 hover:border-slate-300 text-slate-700 rounded-lg text-xs font-semibold shadow-xs transition-all cursor-pointer"
                >
